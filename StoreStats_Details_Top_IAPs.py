...
columns = ['product_id', 'product_name','unified_product_id',
           'unified_product_name', 'publisher_id', 'publisher_name', 
           'main_category', 'has_iap'
           ]
...
if opts.opts_store == "android":
    ...
    print "This script is for iOS Apps only."
    sys.exit()
else:
...
filename = "result_StoreStats_IAPs_" + opts.opts_store + \
          "_" + str(product_id) + \
          ".tsv"
