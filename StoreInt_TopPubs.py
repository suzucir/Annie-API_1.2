...
columns = ['rank', 'category', 'feed', 'publisher_id',
...
parser = argparse.ArgumentParser(
    description='Retrieve App Annie Store Intelligence Top Publisher data \
                 via App Annie API')
parser.add_argument(
...
url = "https://api.appannie.com/v1.2/intelligence/apps/" + \
    query_market + "/publisher-ranking?" + \
...
filename = "result_StoreInt_TopPubs_" + opts.opts_store + \
